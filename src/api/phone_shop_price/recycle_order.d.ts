...
declare module "@/api/phone_shop_price/recycle_order" {
  export function getRecycleOrderList(
    params: RecycleOrderListParams
  ): Promise<ApiResponse>;
  export function updateRecycleOrder(
    id: string,
    data: RecycleOrderUpdateParams
  ): Promise<ApiResponse>;
  export function deleteRecycleOrder(id: number): Promise<ApiResponse>;
  export function updateDeviceStatus(
    id: string,
    data: DeviceStatusUpdateParams
  ): Promise<ApiResponse>;
  export function addRecycleDevice(
    data: RecycleDeviceAddParams
  ): Promise<ApiResponse>;
}
