        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="flex justify-between items-center">
                ...
                <span>
                    ...
                    <el-button @click="syncGoods()"> {{ t('一键同步') }} </el-button>
                </span>
            </div>
            ...
            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="goodsTable.searchParam" ref="searchFormRef">
                    <el-form-item :label="t('商品sn')" prop="goods_name">
                        <el-input v-model="goodsTable.searchParam.sku_no" style="width: 440px"
                            :placeholder="t('请输入商品sn编号,如有多个请以空格隔开,最多支持50个字符')" maxlength="50" clearable />
                    </el-form-item>
                        ...
                        <template #default="{ row }">
                            <div class="flex items-center cursor-pointer" @click="previewEvent(row)">
                                <div class="min-w-[70px] h-[70px] flex items-center justify-center">
                                    ...
                                    <img v-else class="w-[70px] h-[70px]" src="@/addon/shop/assets/goods_default.png"
                                        fit="contain" />
                                </div>
                                <div class="ml-2">
