	...
	<div class="content-wrap" v-show="diyStore.editTab == 'content'">
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="80px" class="px-[10px]">
				...
				<el-form-item :label="t('manyGoodsListAroundRadius')"
		...
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="80px" class="px-[10px]">
				...
				<el-form-item :label="t('goodsNum')">
					<el-slider show-input class="diy-nav-slider" v-model="diyStore.editComponent.num" :min="1" max="20"
						size="small" />
				</el-form-item>
			</el-form>
		</div>
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="80px" class="px-[10px]">
				...
				<el-form-item :label="t('goodsCategoryTitle')"
					v-show="diyStore.editComponent.source == 'goods_category'">
					<el-input v-model.trim="diyStore.editComponent.goods_category_name"
						:placeholder="t('selectCategory')" readonly class="select-diy-page-input"
				...
				<div v-show="diyStore.editComponent.source == 'custom'">
					...
					<div ref="goodsBoxRef">
						<div v-for="(item, index) in diyStore.editComponent.list" :key="item.id"
							...
							<el-form-item :label="t('manyGoodsListSubTitle')"
							...
							<el-form-item :label="t('selectCategory')" v-if="item.source == 'category'">
								<div class="flex items-center w-full">
									<div class="cursor-pointer ml-auto" @click="categoryShowDialogOpen(index)">
										<span class="text-[var(--el-color-primary)]">{{ item.goods_category_name
											}}</span>
							...
							<el-form-item :label="t('customGoods')" v-if="item.source == 'custom'">
								<goods-select-popup ref="goodsSelectPopupRef" v-model="item.goods_ids" :min="1"
									:max="99" />
							</el-form-item>
			...
			<!-- 选择一级商品分类弹出框 -->
			<el-dialog v-model="firstCategoryShowDialog" :title="t('goodsCategoryTitle')" width="750px"
				...
				<el-table :data="firstCategoryTable.data" ref="firstCategoryTableRef" size="large"
					v-loading="firstCategoryTable.loading" height="450px" @current-change="handleCurrentCategoryChange"
					row-key="category_id" highlight-current-row>
					<template #empty>
			...
			<el-dialog v-model="categoryShowDialog" :title="t('goodsCategoryTitle')" width="1000px"
				...
				<el-table :data="categoryTable.data" ref="categoryTableRef" size="large"
					v-loading="categoryTable.loading" height="490px" @selection-change="handleSelectionChange"
		...
		<div class="edit-attr-item-wrap mt-[20px]">
			...
			<el-form label-width="90px" class="px-[10px]">
				...
				<el-form-item :label="t('goodsBtnStyle')" class="!items-center"
		...
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="90px" class="px-[10px]">
				<el-form-item :label="t('goodsSelectPopupGoodsName')"
		...
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="80px" class="px-[10px]">
				<el-form-item :label="t('goodsBgColor')">
					<el-color-picker v-model="diyStore.editComponent.elementBgColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('goodsNameColor')">
					<el-color-picker v-model="diyStore.editComponent.goodsNameStyle.color" show-alpha
						:predefine="diyStore.predefineColors" />
				...
				<el-form-item :label="t('goodsPriceColor')">
					<el-color-picker v-model="diyStore.editComponent.priceStyle.mainColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('goodsBtnColor')">
					<el-color-picker v-model="diyStore.editComponent.saleStyle.color" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('topRounded')">
					<el-slider v-model="diyStore.editComponent.topElementRounded" show-input size="small"
						class="ml-[10px] diy-nav-slider" :max="50" />
				</el-form-item>
				<el-form-item :label="t('bottomRounded')">
					<el-slider v-model="diyStore.editComponent.bottomElementRounded" show-input size="small"
						class="ml-[10px] diy-nav-slider" :max="50" />
				</el-form-item>
			</el-form>
		</div>
		...
		<div class="edit-attr-item-wrap" v-if="diyStore.editComponent.btnStyle.control">
			...
			<el-form label-width="80px" class="px-[10px]">
				<el-form-item :label="t('goodsTextColor')">
					<el-color-picker v-model="diyStore.editComponent.btnStyle.textColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('listFrameColor')">
					<el-color-picker v-model="diyStore.editComponent.btnStyle.startBgColor" show-alpha
						:predefine="diyStore.predefineColors" />
					<icon name="iconfont iconmap-connect" size="20px" class="block !text-gray-400 mx-[5px]" />
					<el-color-picker v-model="diyStore.editComponent.btnStyle.endBgColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
			</el-form>
		</div>
...
console.log(diyStore.editComponent);
