            ...
            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="hsxPhoneQueryConfigTable.searchParam" ref="searchFormRef">
                    <el-form-item :label="t('siteId')" prop="site_id">
                        <el-input v-model="hsxPhoneQueryConfigTable.searchParam.site_id" :placeholder="t('siteIdPlaceholder')" />
                    </el-form-item>
                    <el-form-item :label="t('appid')" prop="appid">
                        <el-input v-model="hsxPhoneQueryConfigTable.searchParam.appid" :placeholder="t('appidPlaceholder')" />
                    </el-form-item>
                    <el-form-item :label="t('secret')" prop="Secret">
                        <el-input v-model="hsxPhoneQueryConfigTable.searchParam.Secret" :placeholder="t('secretPlaceholder')" />
                    </el-form-item>
                    <el-form-item>
...
import { getHsxPhoneQueryConfigList, deleteHsxPhoneQueryConfig } from '@/app/api/hsx_phone_query_config'
import { img } from '@/utils/common'
import { ElMessageBox,FormInstance } from 'element-plus'
import Edit from '@/app/views/hsx_phone_query_config/components/hsx-phone-query-config-edit.vue'
